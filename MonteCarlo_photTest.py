...
############ read me ############
# notice this is just for test the Monte Carlo codes.
# I have changed the error calculation in the photometry function, so it needs the 
# covariance hdu in the test map, which may be added in the future.
